package com.poly.be_duan.payment;
...
public class Controller {
    ...
    public ResponseEntity<JsonNode> PostAPI(HttpServletRequest req,
        ...
        while (iterator.hasNext()) {
            ...
            if ((fieldValue != null) && (fieldValue.length() > 0)) {
                ...
                hashData.append('=');
                hashData.append(URLEncoder.encode(fieldValue, String.valueOf(StandardCharsets.US_ASCII)));
                // Build query
                query.append(URLEncoder.encode(fieldName, String.valueOf(StandardCharsets.US_ASCII)));
                query.append('=');
                query.append(URLEncoder.encode(fieldValue, String.valueOf(StandardCharsets.US_ASCII)));
                if (iterator.hasNext()) {
                    query.append('&');
                    hashData.append('&');
                }
    ...
    public ResponseEntity<JsonNode> customerPostAPI(HttpServletRequest req,
        ...
        vnp_Params.put("vnp_ReturnUrl", Config.vnp_ReturnurlCustomer);
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
        Calendar cld = Calendar.getInstance(TimeZone.getTimeZone("Etc/GMT+7"));
